...
---
_Generated by code-review-multi-axis skill · 11-dimension rubric · PR head `<sha>`_
```
...
```
⚠ code-review-multi-axis skill posts comments as your GitHub identity (<gh-user>).
...
| User Ctrl-C in verb loop | State is already persisted on each verb; safe to re-enter via `/code-review-multi-axis <id>`. |
