...
| [`grill-me-auto`](./grill-me-auto) | Batch-mode `grill-me`: dumps every question, option, recommendation, and alt into one collapsible markdown grill doc at `.grills/<YYYY-MM-DD-HHMM>-<slug>-<depth>.md`; user answers in one shot via three shortcuts (`ACCEPT_ALL_RECOMMENDATIONS`, `ACCEPT_ALL_ALT_RECOMMENDATIONS`, or per-question key) |
