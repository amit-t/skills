...
Place each gap thoughtfully by change type — don't dump everything into "Recent Changes":
...
- Additive by default: leave working prose as-is.
...
- Leave generated artefacts untouched (e.g. `graphify-out/`, autogenerated API docs, build outputs).
